...
define('CAROUSEL_TRANSITION', [
    'fade',
    'swipe',
]);

// EG Search Terms
define('CAROUSEL_MARC_AUDIENCE', [
    'adult' => 'audience(e,g)',
    'teen' => 'audience(d)',
    'juvenile' => 'audience(a,b,c,j)',
]);

define('CAROUSEL_LITFORM', [
...
define('CAROUSEL_SEARCH', [
    'adult_fiction' => CAROUSEL_MARC_AUDIENCE['adult'] . ' ' . CAROUSEL_FORMAT['print'] . ' ' . CAROUSEL_LITFORM['fiction'],
