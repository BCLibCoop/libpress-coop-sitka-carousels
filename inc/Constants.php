...
class Constants
{
    ...
    public const SEARCH = [
        'adult_fiction' => self::MARC_AUDIENCE['adult'] . ' ' . self::FORMAT['print'] . ' ' . self::LITFORM['fiction'],
        'adult_nonfiction' => self::MARC_AUDIENCE['adult'] . ' ' . self::FORMAT['print'] . ' ' . self::LITFORM['nonfiction'],
        'adult_largeprint' => self::MARC_AUDIENCE['adult'] . ' ' . self::FORMAT['large_print'],
        'adult_dvds' => self::MARC_AUDIENCE['adult'] . ' ' . self::FORMAT['dvd'],
        'adult_music' => self::MARC_AUDIENCE['adult'] . ' ' . self::FORMAT['cd'],
        'teen_fiction' => self::MARC_AUDIENCE['teen'] . ' ' . self::FORMAT['print'] . ' ' . self::LITFORM['fiction'],
        'teen_nonfiction' => self::MARC_AUDIENCE['teen'] . ' ' . self::FORMAT['print'] . ' ' . self::LITFORM['nonfiction'],
        'juvenile_fiction' => self::MARC_AUDIENCE['juvenile'] . ' ' . self::FORMAT['print'] . ' ' . self::LITFORM['fiction'],
        'juvenile_nonfiction' => self::MARC_AUDIENCE['juvenile'] . ' ' . self::FORMAT['print'] . ' ' . self::LITFORM['nonfiction'],
        'juvenile_dvdscds' => self::MARC_AUDIENCE['juvenile'] . ' ' . self::FORMAT['dvdscds'],
    ];
}
